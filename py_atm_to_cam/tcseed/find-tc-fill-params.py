...
if __name__ == "__main__":
    ...
    # Add command-line arguments for inic_file and pthi
    ...
    # Run the process_vortex function with arguments from command line
    process_vortex(args.vortex_namelist, args.inic_file)
