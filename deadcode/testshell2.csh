...
then
  ...
  while [  $COUNTER -lt 900 ]; do
    ...
    then
      ...
      outflds=(wind tmq flut prect mslp)
...
cp /home/zarzycki/sewx/INIC/tcforecast_60_x4_INIC_filter.nc $procdir
...
sed 's?^###SBATCH --begin.*?###SBATCH --begin="'$resubhour'":30?' testshell.csh > testshell2.csh
