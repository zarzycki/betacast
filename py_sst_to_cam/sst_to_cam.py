...
DOMAINSPATH = os.path.join(BETACAST, 'grids/domains/')

# Unpack arguments
initdate = args.initdate
predict_docn = args.predict_docn
inputres = args.inputres
datasource = args.datasource
sstDataFile = args.sstDataFile
iceDataFile = args.iceDataFile
SST_write_file = args.SST_write_file
