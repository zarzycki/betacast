...
then
  ...
  tail -n +2 dates5.txt > dates6.txt
  mv dates6.txt dates5.txt
fi
...
then
  ...
  path_to_gz_touch=$path_to_se_build/${gridname}_3/run
  path_to_nc_files=$path_to_se_build/${gridname}_3/run
  outputdir=/home/$LOGNAME/${gridname}_3/run
else
  echo "Machine"
fi
...
cd $path_to_se_build/${gridname}_3
